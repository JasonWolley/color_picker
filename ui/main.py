...
"")
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.material_design_tab.sizePolicy().hasHeightForWidth())
        ...
        self.material_design_gridLayout = QtWidgets.QGridLayout(self.material_design_tab)
        self.material_design_gridLayout.setSpacing(0)
        self.material_design_gridLayout.setContentsMargins(0, 0, 0, 0)
        self.material_design_gridLayout.setObjectName("material_design_gridLayout")
